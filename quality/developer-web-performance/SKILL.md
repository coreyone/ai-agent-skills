...
- Request explicitly references `developer-web-performance` or this source file.
- Request language includes terms like: developer, web, performance.
...
- Source of truth: `subagents/rules/developer/developer-web-performance.md`
