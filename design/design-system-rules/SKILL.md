...
- Request explicitly references `design-system-rules` or this source file.
- Request language includes terms like: design, system, rules.
...
- Source of truth: `subagents/rules/design/design-system-rules.md`
