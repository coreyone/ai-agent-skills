...
- Request explicitly references `design-review-rules` or this source file.
- Request language includes terms like: design, review, rules.
...
- Source of truth: `subagents/rules/design/design-review-rules.md`
