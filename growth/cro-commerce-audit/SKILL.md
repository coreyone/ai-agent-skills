...
- Request explicitly references `CRO-Commerce-Audit` or this source file.
- Request language includes terms like: CRO, Commerce, Audit.
...
- Source of truth: `subagents/rules/CRO-Commerce-Audit.md`
